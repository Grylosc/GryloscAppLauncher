...
AppId={{3D4C76ED-0CE4-497B-902A-39346636359A}
AppName={#MyAppName}
...
[Files]
Source: "D:\Documents\programs\CS\GryloscAppLauncher\GryloscAppLauncher\bin\Release\net8.0-windows\publish\win-x64\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\Documents\programs\CS\GryloscAppLauncher\GryloscAppLauncher\bin\Release\net8.0-windows\publish\win-x64\D3DCompiler_47_cor3.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\Documents\programs\CS\GryloscAppLauncher\GryloscAppLauncher\bin\Release\net8.0-windows\publish\win-x64\GryloscAppLauncher.pdb"; DestDir: "{app}"; Flags: ignoreversion
